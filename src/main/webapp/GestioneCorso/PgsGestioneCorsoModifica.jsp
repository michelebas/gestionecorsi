                                        ...
                                        <%
                                            ...
                                            if(!elencoDocenti.isEmpty()){
                                                for(Docente doc:elencoDocenti){
                                                    if(doc.getChiave() == beanCorso.getObjDocente().getChiave()){
                                        %>
                                        <tr>
                                            <td><input type="radio" name="rdoIdDocente" value="<%= doc.getChiave() %>" checked="checked"></td>
                                    ...
                                    <table class="table table-hover table-dark table-responsive-sm mt-3">
                                        ...
                                        <tr>
                                            <%
                                                ...
                                                List<Discente> elencoDiscenti = discenteService.findAll();
                                                for(Discente discente : beanCorso.getDiscenti()){
                                            %>
                                            <td><input type="checkbox" name="checkIdDiscente" value="<%= discente.getChiave() %>" checked = "checked"></td>
