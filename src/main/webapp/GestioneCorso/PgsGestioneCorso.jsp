...
<html>
    ...
    <body>
        ...
        <div align="center" class="container mt-3" style="box-shadow: 0 0 30px rgba(0, 0, 0, .5); background: transparent; border-radius: 20px; border: 2px solid rgba(255, 255, 255, .5);">
